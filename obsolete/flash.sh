...
upload_ril()
{
	echo Uploading RIL
	run_adb wait-for-device &&
	run_adb root && sleep 5 && run_adb wait-for-device &&
	run_adb remount || (echo "Cannot remount"; return 1)
	test -e ril/libqc_b2g_ril && run_adb push ril/libqc_b2g_ril /system/b2g/distribution/bundles/libqc_b2g_ril
	test -e ril/libqc_b2g_location && run_adb push ril/libqc_b2g_location /system/b2g/distribution/bundles/libqc_b2g_location
	run_adb push ril/libqc_b2g_ril.version /system/b2g/libqc_b2g_ril.version
	test -f custom.js && run_adb push custom.js /system/b2g/defaults/pref/custom.js
}
